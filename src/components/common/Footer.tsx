...
import { Code, FlutterDash, GitHub, Language, LocationOn } from '@mui/icons-material';
...
const Footer = () => {
  ...
  return (
    <Box sx={{ backgroundColor: '#B0EACD', color: '#212529', padding: '40px 0' }}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={3}>
            ...
            <Typography variant="body1">
              Learn Code is a leading EdTech platform, primarily known for its specialization in software development.
              We offer major courses in mobile and web development online. Our core mission is to provide research and
              development, education, and community leadership.
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} md={3}>
            ...
            <Typography variant="body1">
              <IconButton><GitHub /></IconButton> Git & GitHub
            </Typography>
            <Typography variant="body1">
              <IconButton><FlutterDash /></IconButton> Flutter
            </Typography>
            <Typography variant="body1">
              <IconButton><Language /></IconButton> MERN Stack
            </Typography>
            <Typography variant="body1">
              <IconButton><Code /></IconButton> Python
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} md={3}>
           ...
           <Newsletter/>
            ...
            <Typography variant="body1" sx={{ display: 'flex', marginTop: '10px', alignItems: 'center', marginBottom: 2 }}>
